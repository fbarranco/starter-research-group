...
* Déniz, D., G. Jimenez-Perera, R. Nolasco, J. Corral, F. Barranco. **Deep multimodal habit tracking system: A user-adaptive approach for low-power embedded systems.** Journal of Signal Processing Systems (2023), [PDF](https://doi.org/10.1007/s11265-023-01840-4) [CODE](https://github.com/DaniDeniz/deep-multimodal-action-recognition) [DATA](https://github.com/DaniDeniz/CIAV-dataset)
* Isern, J., G. Jimenez-Perera, L. Medina-Valdés, P. Chaves, D. Pampliega, F. Ramos, F. Barranco. **A Cyber-Physical System for integrated remote control and protection of smart grid critical infrastructures.** Journal of Signal Processing Systems (2023), [PDF](https://doi.org/10.1007/s11265-023-01842-2)
* Deniz, D.,  J. Isern, J. Solanti, P. Jääskeläinen, P. Hnětynka, L. Bulej, E. Ros, F. Barranco. **Efficient reconfigurable CPS for monitoring the elderly at home via Deep Learning**, submitted to Engineering Applications of Artificial Intelligence, 2022. [PDF](https://digibug.ugr.es/handle/10481/71603) [DATA](https://github.com/DaniDeniz/IndoorActionDataset)  
* Cuadrado, J., U. Rancon, B.R. Cottereau, F. Barranco, T. Masquelier, **Optical flow estimation from event-based cameras and spiking neural networks**, Frontiers in Neuroscience, 17, 1160034, (2023) [PDF](https://doi.org/10.3389/fnins.2023.1160034) [CODE](https://github.com/j-cuadrado/of_ev_snn)
* Deniz, D., C. Fermuller, E. Ros, M.Rodriguez-Alvarez, F. Barranco. **Event-based vision for early prediction of manipulation actions**, submitted since January 2023 to IEEE T. on Pattern analysis and machine intelligence. [DATA](https://github.com/DaniDeniz/DavisHandDataset-Events)
* Deniz, D., E. Ros, E. M. Ortigosa, F. Barranco. **Optimized edge-cloud system for activity monitoring using knowledge distillation**, submitted June 2023 to IEEE T. on Mobile Computing. 
* Novo, A., F. Lobon, H. G. de Marina, S. Romero, F. Barranco. **Brain-Inspired Autonomous Robotic Navigation: A Survey**, submitted in March 2023 to ACM Computing Surveys.
* Barranco, F., M. Rodríguez-Álvarez, S. Romero, E. Martínez-Ortigosa. **Learning object contours using bio-inspired spatio-temporal features**, In preparation, 2023.
* Lobón, F., A. Novo, S. Romero, F. Barranco. **Segmentation of Independently-Moving Objects using neuromorphic sensors**, In preparation, 2023. [CODE](https://github.com/FranLV/TFM_Fran_Lobon) [DATA](https://github.com/FranLV/TFM_Fran_Lobon)
